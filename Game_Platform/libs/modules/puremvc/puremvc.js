        ...
        (function (puremvc) {
            ...
            var Controller = (function () {
                ...
                Controller.prototype.executeCommand = function (notification) {
                    var commandIns = this.commandMap[notification.getName()];
                    if(commandIns) {
                        // var command = new commandClassRef();
                        commandIns.execute(notification);
                    }
                };
                Controller.prototype.registerCommand = function (notificationName, commandIns) {
                    if(!this.commandMap[notificationName]) {
                        this.view.registerObserver(notificationName, new puremvc.Observer(this.executeCommand, this));
                    }
                    this.commandMap[notificationName] = commandIns;
                };
