module game.bjl {
	export class BjlDyzRoad extends eui.Component implements eui.UIComponent{
		public constructor() {
			super();
		}
		...
		public roadRowLists : BjlDyzRowList[];
