module game.by {
	export class BYTrackShowUI extends GameScene{
		public constructor() {
			super();
		...
		private ontesttrack() {
			try {
				...
				this.curFish = new NFish("123123123123",2,0,0,0);
				this.fishGroup.addChild(this.curFish);
				this.curFish.speed = Number(this.speedInput.editInput.text);
