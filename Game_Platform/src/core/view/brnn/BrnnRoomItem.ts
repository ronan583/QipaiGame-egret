class BrnnRoomItem extends eui.Component implements  eui.UIComponent {
	public constructor() {
		super();
	}
	...
	private stateArr:Array<string> = ["brnnn_kongxian", "brnnn_yongji", "brnnn_baomao"];
	private randomState() {
