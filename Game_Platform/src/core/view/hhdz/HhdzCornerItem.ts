module game.hhdz {
	export class HhdzCornerItem extends eui.Component implements eui.UIComponent{
		public constructor() {
			super();
		}
		...
		public cornerPanel : HhdzCornerRoad;
		...
		public initData(data)
		{
			...
			}else
			{
				...
				HhdzRequest.requestSingleRoom(this.roomId);
			...
			this.xianNumLabel.text = "红 " + longNum.toString();
			this.zhuangNumLabel.text = "黑 " + huNum.toString();
		...
		public onEnterGame(event)
		{
			...
			RoomRequest.sendEnterRoomInfo(ChildGameType.HHDZ ,lType);
			AppFacade.instance.sendNotification(PanelNotify.CLOSE_HHDZ_START_UI);
