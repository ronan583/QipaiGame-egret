class BcbmSettingPanel extends ResizePanel implements eui.UIComponent {
	public constructor() {
		super();
		this.skinName = "resource/eui_skins/bcbm/BcbmSettingPanel.exml";
	...
	protected childrenCreated(): void {
		...
		this.confirmBtn.addEventListener(egret.TouchEvent.TOUCH_TAP, this.closeBtnClick, this);
		this.initPanel();
	}
