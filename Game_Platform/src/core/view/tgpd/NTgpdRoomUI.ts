module game.tgpd {
    export class NTgpdRoomUI extends RoomUI {
        ...
        public PUTONG_RECOMMEND: number = 10000;
        ...
        private onQuickStart() {
            ...
            if (user.money < this.PUTONG_RECOMMEND) {
                TgpdRequest.enterGame(0);
                CandyData.instance.enterRoomLevel = 0;
            } else if (user.money >= this.PUTONG_RECOMMEND) {
        ...
        private onItem2() {
            SoundMenager.instance.PlayClick();
            if (UserService.instance.money < this.PUTONG_RECOMMEND) {
        ...
        public enterBattle(layer: number): void {
            let anim = "animation_" + layer;
        ...
        private curtainDownAnim(func: Function, funcObj: any, anim: string) {
            this.func = func;
