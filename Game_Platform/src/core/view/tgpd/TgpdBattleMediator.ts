module game.tgpd {
	export class TgpdBattleMediator extends GameMeditator {
		...
		public listNotificationInterests(): Array<any> {
			return [
				PanelNotify.OPEN_TGPD_ROOM_CURTAIN,
		...
		public tgpdRoom: game.tgpd.NTgpdRoomUI = null;
		public handleNotification(notification: puremvc.INotification): void {
			var data: any = notification.getBody();
			// if(notification.getName() != PanelNotify.OPEN_TGPD_ROOM_CURTAIN && (this.tgpdBattleScene == null || this.tgpdBattleScene.stage == null))
			// {
			// 	return;
			// }
			switch (notification.getName()) {
				case PanelNotify.OPEN_TGPD_ROOM_CURTAIN: {
					this.tgpdRoom.enterBattle(data);
				}
					break;
