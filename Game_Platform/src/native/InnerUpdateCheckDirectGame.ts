...
class InnerUpdateCheckDirectGame {
	...
	public startCheck(gameType:game.ChildGameType, assignUrl:string) {
		this.curGameType = gameType;
		Global.getBasicData = assignUrl + "\gamedata.json";
		egret.log("从sdk获取assignUrl : " + assignUrl);
	...
	private onRootServerComplete(data:string) {
		...
		Global.SDK_CODE = updateInfo.sdkCode;
