module game {
	...
	export enum ChildGameTypeGroup{
		DUOREN = 0,
		QIPAI = 1,
		JIEJI = 2
	}
	...
	export class GameConst {
		...
		public static GAME_DUOREN:Array<ChildGameType> = [ChildGameType.BRNN, ChildGameType.BJL, ChildGameType.HHDZ, ChildGameType.LHDZ, ChildGameType.BCBM, ChildGameType.FQZS];
		...
		public static getGroupByGame(type: number): ChildGameTypeGroup{
			if(this.GAME_DUOREN.indexOf(type) > 0){
				return ChildGameTypeGroup.DUOREN;
			} else if(this.GAME_QIPAI.indexOf(type) > 0){
				return ChildGameTypeGroup.QIPAI;
			} else if(this.GAME_JIEJI.indexOf(type) > 0){
				return ChildGameTypeGroup.JIEJI;
			} else {
				return -1;
			}
		}
