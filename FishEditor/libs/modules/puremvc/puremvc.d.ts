...
declare module puremvc
{
	...
	export interface IController
	{
		...
		registerCommand( notificationName:string, commandIns:any ):void;
		...
		implements IController
	{
        ...
        public registerCommand(notificationName: string, commandIns: any): void;
		...
		implements ICommand, INotifier
	{
        ...
        public addSubCommand(commandIns: any): void;
