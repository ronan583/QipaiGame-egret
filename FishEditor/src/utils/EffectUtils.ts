...
module EffectUtils {
    ...
    //obj         闪烁对象
    //interval    闪烁总工时间
    export function blinkEffect1(obj,interval:number = 1000):BitmapBlink{
       return new BitmapBlink(obj,interval); 
    }
    ...
    */
    export function playEffect1(obj,cartoonType:number = 2):void{
