class LhdzCuopai extends eui.Component implements  eui.UIComponent {
	public constructor() {
		super();
	}
	...
	protected childrenCreated():void
	{
		...
		let data = RES.getRes("lhdz_cuopai_mc_json");
		let txtr = RES.getRes("lhdz_cuopai_tex_png");
		var mcFactory:egret.MovieClipDataFactory = new egret.MovieClipDataFactory( data, txtr );
		this.fanpaiMc = new egret.MovieClip(mcFactory.generateMovieClipData("lhdz_cuopai"));
