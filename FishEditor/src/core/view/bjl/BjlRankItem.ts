module game.bjl {
	export class BjlRankItem extends eui.Component implements eui.UIComponent{
		public constructor() {
			super();
		}
		...
		public initItem()
		{
			...
			this.headIcon.source = "gp_head_" + this.data.headNum;//"icon_" + this.data.headNum + "_png";
			...
			if(this.rank == 0)
			{
				...
				this.topIcon.source = "bjlGame_json.star";
			...
			}else
			{
				...
				{
					this.topIcon.visible = true;
					this.topIcon.source = "bjlGame_json.rich_" + this.rank;
					this.rankNumLabel.visible = false;
				}else
				{
