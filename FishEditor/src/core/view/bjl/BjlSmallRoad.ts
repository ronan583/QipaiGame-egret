module game.bjl {
	export class BjlSmallRoad extends eui.Component implements eui.UIComponent{
		public constructor() {
			super();
		}
		...
		public roadRowLists : BjlSmallRowList[];
		...
		{
			var currRowList : BjlSmallRowList;
		...
		{
			var currRowList : BjlSmallRowList;
			currRowList = new BjlSmallRowList();
