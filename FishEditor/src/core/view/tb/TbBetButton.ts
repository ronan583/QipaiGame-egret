module game.tb {
	export class TbBetButton extends eui.Component implements eui.UIComponent{
		public constructor() {
			super();
			this.skinName='resource/eui_skins/tb/TbBetButtonSkin.exml';
		}
		...
		public showButton(gameLevel : number , value : number)
		{
			...
			this.betImage.source = "diceGame_json.level" + gameLevel + "_chip_" + value;
		}
		...
		public showLittleButton(gameLevel : number , value : number)
		{
			...
			this.betImage.width = 38;
			this.betImage.height = 38;
			this.betImage.source = "diceGame_json.level" + gameLevel + "_chip_" + value + "_little";
			this.width = 38;
			this.height = 38;
		...
		public openLight()
		{
			...
			var color:number = GameConst.getTbBetColor(this.index);;        /// 光晕的颜色，十六进制，不包含透明度
		...
		// public enable
		public cloneBet(betBtn : TbBetButton)
		{
